...
QRCode qrcode;
String paypalLink = "HelloWorld1234567890ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghij";
...
void setup() {
  ...
  mySerial.write(1);   // -2 dots (adjust as needed for tighter overlap)

  uint8_t qrcodeData[qrcode_getBufferSize(3)];
  qrcode_initText(&qrcode, qrcodeData, 3, ECC_LOW, paypalLink.c_str() );
