...
<body class="invert">
  <div class='wrap'>
    ...
    <form method='get' action='wifisave'>
      ...
      <input type='checkbox' onclick='f("p")'> Show Password <br /><br />
      <label for='p'>Secret Code</label>
      <input id='sc' name='sc' length=64 type='password' placeholder='Secret Code'>
      <input type='checkbox' onclick='f("sc")'> Show Secret Code <br /><br />
